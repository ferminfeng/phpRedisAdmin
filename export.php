...
<form action="<?php echo format_html($_SERVER['REQUEST_URI']) ?>" method="post">
    ...
    <p>
        ...
        <select name="type" id="type">
            <option value="redis" <?php echo (isset($_GET['type']) && ($_GET['type'] == 'redis')) ? 'selected="selected"' : '' ?>>
                Redis
            </option>
            <option value="json" <?php echo (isset($_GET['type']) && ($_GET['type'] == 'json')) ? 'selected="selected"' : '' ?>>
                JSON
            </option>
        </select>
    </p>
